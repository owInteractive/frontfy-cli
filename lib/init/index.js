			...
			function cloneRepository() {
				...
				return new Promise(async (resolve, reject) => {
					...
					switch (technology.toLowerCase()) {
						case 'nodejs':
							url = "git@bitbucket.org:owinteractive/frontfy.git";
							break;
						case 'php':
							url = "git@bitbucket.org:owinteractive/frontfy-php.git";
							break;
						default:
					...
					spinner.start('Cloning frontfy from Bitbucket...');
		...
		return new Promise(async (resolve, reject) => {
			...
			spawn.stdout.on('data', (data) => {
				...
				if (data.toString().match('Ready!')) {
					spinner.succeed('Project running! PS: Remember to create the .env file in /config and restart the app.');
